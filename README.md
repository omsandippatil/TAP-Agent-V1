...
**The Apprentice Project — Fundraising**
📧 fundraising@theapprenticeproject.org

*All data is sourced from the public web. Every claim carries a source citation and is re-verified against raw source text.*